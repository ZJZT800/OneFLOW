...
void UINsVisterm::PrepareField()
{
	...
	ONEFLOW::CalcINsGrad((*uinsf.q)[IIDX::IIU], (*uinsf.dqdx)[IIDX::IIU], (*uinsf.dqdy)[IIDX::IIU], (*uinsf.dqdz)[IIDX::IIU]);
	ONEFLOW::CalcINsGrad((*uinsf.q)[IIDX::IIV], (*uinsf.dqdx)[IIDX::IIV], (*uinsf.dqdy)[IIDX::IIV], (*uinsf.dqdz)[IIDX::IIV]);
	ONEFLOW::CalcINsGrad((*uinsf.q)[IIDX::IIW], (*uinsf.dqdx)[IIDX::IIW], (*uinsf.dqdy)[IIDX::IIW], (*uinsf.dqdz)[IIDX::IIW]);
...
void UINsVisterm::CalcVisterm()
{
	...
	for (int fId = ug.nBFace; fId < ug.nFace; ++fId)
	{
		...
		this->CalcFaceVisterm(dudx, dudy, dudz, dvdx, dvdy, dvdz, dwdx, dwdy, dwdz);
	...
	for (int fId = 0; fId < ug.nBFace; ++fId)
	{
		...
		this->CalcBcFaceVisterm(dudx, dudy, dudz, dvdx, dvdy, dvdz, dwdx, dwdy, dwdz);
...
void UINsVisterm::CalcFaceVisterm(RealField & dudx, RealField & dudy, RealField & dudz, RealField & dvdx, RealField & dvdy, RealField & dvdz, RealField & dwdx, RealField& dwdy, RealField& dwdz)
{
	...
	Real fdudx = (*ug.fl)[ug.fId] * dudx[ug.lc] + (*ug.fr)[ug.fId] * dudx[ug.rc];
	Real fdudy = (*ug.fl)[ug.fId] * dudy[ug.lc] + (*ug.fr)[ug.fId] * dudy[ug.rc];
	Real fdudz = (*ug.fl)[ug.fId] * dudz[ug.lc] + (*ug.fr)[ug.fId] * dudz[ug.rc];
	Real fdvdx = (*ug.fl)[ug.fId] * dvdx[ug.lc] + (*ug.fr)[ug.fId] * dvdx[ug.rc];
	Real fdvdy = (*ug.fl)[ug.fId] * dvdy[ug.lc] + (*ug.fr)[ug.fId] * dvdy[ug.rc];
	Real fdvdz = (*ug.fl)[ug.fId] * dvdz[ug.lc] + (*ug.fr)[ug.fId] * dvdz[ug.rc];
	Real fdwdx = (*ug.fl)[ug.fId] * dwdx[ug.lc] + (*ug.fr)[ug.fId] * dwdx[ug.rc];
	Real fdwdy = (*ug.fl)[ug.fId] * dwdy[ug.lc] + (*ug.fr)[ug.fId] * dwdy[ug.rc];
	Real fdwdz = (*ug.fl)[ug.fId] * dwdz[ug.lc] + (*ug.fr)[ug.fId] * dwdz[ug.rc];
...
void UINsVisterm::CalcBcFaceVisterm(RealField& dudx, RealField& dudy, RealField& dudz, RealField& dvdx, RealField& dvdy, RealField& dvdz, RealField& dwdx, RealField& dwdy, RealField& dwdz)
{
